...
export default function Analytics() {
  ...
  return <>
    ...
    />
    <noscript><iframe src={`https://nhsx-standards.containers.piwik.pro/${process.env.TRACKING_ID}/noscript.html`} height="0" width="0" style={{display:'none',visibility:'hidden'}}></iframe></noscript>
  </>
}
