...
export function Filters({ schema, categories = ['care_setting', 'topic', 'standard_category'], title = 'Filters', showTitle, before, expanded, className }) {
